...
viser me berre nokre av kolonnane i dei vidare eksempela:
...
### Valideringsdatasett med datavariablar i fast rekkjefølgje
...
### Alle datavariablar for eit tilfeldig utval pasientar
...
```{r legg til metadata}
d_reg_metadata = select(d_reg_full, pasid, dato_inn, sjukehus)
