...
TLDR-versjonen av dette dokumentet er funksjonar på nivå
![stable](../man/figures/lifecycle-stable.svg){style="vertical-align:middle"}
...
Her følgjer ei nærare skildring av utviklingsnivåa.
...
- Ønskt *hovud*funksjonalitet er fastsett,
  men er ikkje nødvendigvis enno godkjent og alle utviklarane
...
![experimental](../man/figures/lifecycle-experimental.svg){style="vertical-align:middle"}
eksperimentell.
Desse tilrår me ikkje for vanleg bruk.
...
det det medfører at ein trygt kan bruka han i andre (offentlege eller interne).
Men viss han er
![experimental](../man/figures/lifecycle-experimental.svg){style="vertical-align:middle"},
...
For eksterne brukarar (ikkje tilsette på fagsenteret) gjeld regelen
