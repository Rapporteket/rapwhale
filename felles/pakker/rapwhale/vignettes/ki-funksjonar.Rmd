...
Rammeverket vårt løyser problema ovanfor. For brøkbaserte kvalitetsindikatorar
(som for eksempel målar prosentdelen av pasientar oppfyller eit kriterium)
brukar ein følgjande framgangsmåte.
...
KI-funksjonen gjev ut dataramma med (iallfall) desse to variablane lagde til:
...
- `ki_krit_teller`: Logisk variabel som seier om observasjonen oppfølgde
  ...
  skal telja «positivt» i teljaren i brøken.
...
kvaltitetsindikator **skal** ein alltid kunna avgjera om ein observasjon
...
(fixme: Skal her skriva om ei utviding av oppfølgingseksempelet.
Me har eitt datasett for operasjon og eitt datasett for oppfølging.
Ein operasjon kan ha fleire oppfølgingar (ved seks månadar, eitt år osv.),
og KI-funksjonen tar inn fleire datasett. Strukturen på utdataa
vert altså ikkje lik strukturen på inndataa.)
