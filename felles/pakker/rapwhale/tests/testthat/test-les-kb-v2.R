...
kb_tom = tibble(skjemanavn = character(), 
...
kb_eksempel = data.frame(stringsAsFactors = FALSE,
                         ...
                         lovlige_tegn = c("1234567890",NA_character_,
                         ...
                         hjelpetekst = c("Pasient ID - automatisk løpenummer i databasen.",
...
# test_that("funksjonen håndterer variabler med desimaltall", {
#   kb_desimal = kb_tom %>% 
#     add_row(normalintervall_start_numerisk = c(1.2,1.3), 
...
#   kb_dato = kb_tom %>% 
#     add_row(normalintervall_start_dato = c("2020-02-03", "1980-01-01"), 
