...
test_that("Funksjonen leser inn en variabel selv om den ikke har navn", {
  ...
  expect_identical(les_varnavn(dd_sti = paste0(mappe, dd_kolonne_uten_navn)), forventet_uten_navn)
})
...
test_that("Funksjonen gir feilmelding om to variabler har samme navn i datadump", {
  ...
  expect_error(les_varnavn(dd_sti = paste0(mappe, dd_to_kolonner_med_samme_navn)), forventet_med_samme_navn)
})
...
test_that("Funksjonen leser inn variabler med mellomrom i navnet", {
  ...
  expect_identical(les_varnavn(dd_sti = paste0(mappe, dd_kolonnenavn_med_mellomrom)), forventet_med_mellomrom)
})
...
test_that("Funksjonen leser inn variabler hvor navnet starter med et tall", {
  ...
  expect_identical(les_varnavn(dd_sti = paste0(mappe, dd_kolonnenavn_som_starter_med_tall)), forventet_med_tall)
})
...
test_that("Funksjonen leser inn variabler med bindestrek i navnet", {
  ...
  expect_identical(les_varnavn(dd_sti = paste0(mappe, dd_kolonnenavn_med_bindestrek)), forventet_med_bindestrek)
})
