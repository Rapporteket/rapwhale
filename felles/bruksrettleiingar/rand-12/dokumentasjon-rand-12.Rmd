...
RAND-12 norsk versjon 1 og SF-12 norsk versjon 1.1 og 1.2. Dette dokumentet er ment som et 
...
Funksjonen regner ut både fysisk og psykisk sumskår (PCS og MCS) for 
RAND-12- eller SF-12-spørreskjema og legger disse til datasettet som
inneholder RAND-12- eller SF-12-besvarelsene. Funksjonen sjekker også at 
alle variabelnavnene og verdiene/besvarelsene er kodet riktig.
...
Det finnes ulike algoritmer for skåring av RAND-12/SF-12, men foreløpig 
er det bare mulig å velge `"farivar_2007_oblique"` i skaar_rand12().
Denne algoritmen gir sumskårer basert på en korrelert (skrå/«oblique»)
faktormodell og er basert på engelsk versjon av SF-12 versjon 1 (med 
amerikansk referansepopulasjon), men den kan også brukes for (og er 
foreløpig det beste alternativet for) RAND-12 norsk versjon 1 og SF-12 
norsk versjon 1.1 og 1.2. Funksjonen kan *ikke* brukes for skåring av 
versjon 2 av SF-12 (dette skjemaet har for noen spørsmål flere mulige 
svaralternativer).

# SPSS-syntaksen vs. skaar_rand12()
