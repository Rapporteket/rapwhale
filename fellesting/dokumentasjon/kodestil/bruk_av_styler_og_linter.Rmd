...
![Dei ulike `styler`-vala i Addins-menyen.](screenshots/styler-meny.png)
...
![Endra snarvegar.](screenshots/snarvegar-meny.png)
...
![Nye `styler`-snarvegar.](screenshots/styler-nye-snarvegar.png)
...
![Dei ulike `lintr`-vala i Addins-menyen.](screenshots/lintr-meny.png)
...
![Nye `lintr`-snarvegar.](screenshots/lintr-nye-snarvegar.png)
...
![Eksempel på køyring av `lintr` på ei fil.](screenshots/lintr-eksempel.png)
